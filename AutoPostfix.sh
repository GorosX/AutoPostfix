...
read -p "Introduce la dirección de correo para CC: " CC_EMAIL
read -p "Introduce el asunto del mensaje: " ASUNTO

# Enviar el correo electrónico

echo "Correo electrónico de prueba" | mail -s "$ASUNTO" -c "$CC_EMAIL" "$EMAIL"

echo "Se ha enviado un mensaje de confirmación a $EMAIL, con CC a $CC_EMAIL."
